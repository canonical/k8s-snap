...
func TestEtcd(t *testing.T) {
	t.Run("Args", func(t *testing.T) {
		...
		g.Expect(setup.Etcd(s, "t1", "https://127.0.0.1:2379", "https://127.0.0.1:2380", nil, nil)).To(Succeed())
		...
		tests := []struct {
			...
			{key: "--state-dir", expectedVal: s.EtcdDir()},
		}
	...
	t.Run("JoiningNode", func(t *testing.T) {
		...
		// Create a mock snap
		s := mockEtcdSnap(t)
		g.Expect(setup.Etcd(s, "t1", "https://127.0.0.1:2379", "https://127.0.0.1:2380", []string{"https://10.0.0.1:2379"}, nil)).To(Succeed())
