...
func TestDisabled(t *testing.T) {
	t.Run("HelmApplyFails", func(t *testing.T) {
		...
		status, err := calico.ApplyNetwork(context.Background(), nil, snapM, apiserver, network, nil)
...
func TestEnabled(t *testing.T) {
	t.Run("InvalidPodCIDR", func(t *testing.T) {
		...
		status, err := calico.ApplyNetwork(context.Background(), nil, snapM, apiserver, network, defaultAnnotations)
