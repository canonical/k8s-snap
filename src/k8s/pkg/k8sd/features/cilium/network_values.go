...
type networkValues map[string]any

func (v *networkValues) applyDefaults() error {
...
func (v *networkValues) applyStrict() error {
...
func (v *networkValues) applyImages() error {
	values := networkValues{
...
func (v *networkValues) applyClusterConfig(ctx context.Context, s state.State, apiserver types.APIServer, network types.Network) error {
	c, err := s.Leader()
	if err != nil {
...
func (v *networkValues) applyAnnotations(annotations types.Annotations) error {
