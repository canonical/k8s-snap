...
type Feature interface {
	...
	GetDefaultValues(name string) map[string]any
}
...
type FeatureManifest struct {
	...
	DefaultValues map[string]map[string]any `yaml:"default-values,omitempty"`
}
...
func (f FeatureManifest) GetDefaultValues(name string) map[string]any {
	return f.DefaultValues[name]
}
