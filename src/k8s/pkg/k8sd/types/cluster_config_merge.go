...
func MergeClusterConfig(existing ClusterConfig, new ClusterConfig) (ClusterConfig, error) {
	...
	for _, i := range []struct {
		...
		{name: "datastore ca", val: &config.Certificates.DatastoreCACert, old: existing.Certificates.DatastoreCACert, new: new.Certificates.DatastoreCACert, allowChange: true},
		{name: "datastore client certificate", val: &config.Certificates.DatastoreClientCert, old: existing.Certificates.DatastoreClientCert, new: new.Certificates.DatastoreClientCert, allowChange: true},
		{name: "datastore client key", val: &config.Certificates.DatastoreClientKey, old: existing.Certificates.DatastoreClientKey, new: new.Certificates.DatastoreClientKey, allowChange: true},
