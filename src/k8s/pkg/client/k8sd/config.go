...
func (c *k8sd) SetClusterConfig(ctx context.Context, request apiv1.UpdateClusterConfigRequest) error {
	if err := c.client.Query(ctx, "PUT", apiv1.K8sdVersionPrefix, api.NewURL().Path("k8sd", "cluster", "config"), request, nil); err != nil {
...
func (c *k8sd) GetClusterConfig(ctx context.Context) (apiv1.UserFacingClusterConfig, error) {
	...
	if err := c.client.Query(ctx, "GET", apiv1.K8sdVersionPrefix, api.NewURL().Path("k8sd", "cluster", "config"), nil, &response); err != nil {
