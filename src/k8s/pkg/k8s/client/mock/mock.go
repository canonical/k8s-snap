...
type Client struct {
	...
	KubeConfigErr                 error
	DeleteClusterMemberCalledWith apiv1.RemoveNodeRequest
	DeleteClusterMemberErr        error
	...
	CleanupKubernetesServicesErr  error
	WaitForDqliteNodeToBeReadyErr error
	ResetClusterMemberErr         error
...
func (c *Client) DeleteClusterMember(ctx context.Context, request apiv1.RemoveNodeRequest) error {
	c.DeleteClusterMemberCalledWith = request
	return c.DeleteClusterMemberErr
}

func (c *Client) CleanupKubernetesServices(ctx context.Context) error {
	return c.CleanupKubernetesServicesErr
}

func (c *Client) ResetClusterMember(ctx context.Context, name string, force bool) error {
	return c.ResetClusterMemberErr
}
...
func (c *Client) WaitForMicroclusterNodeToBeReady(ctx context.Context, nodeName string) error {
	return c.WaitForDqliteNodeToBeReadyErr
}
