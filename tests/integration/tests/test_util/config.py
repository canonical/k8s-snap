...
# LXD_DUAL_NIC_NETWORK is an optional network to be used in LXD containers with dual NIC.
LXD_DUAL_NIC_NETWORK = os.getenv("TEST_LXD_DUAL_NIC_NETWORK") or "dual-nic-br0"
