...
<!-- snap end -->
<!-- lxd start -->
lxc exec k8s -- sudo snap install k8s --classic --channel=1.37-classic/stable
<!-- lxd end -->
<!-- offline start -->
sudo snap download k8s --channel 1.37-classic/stable --basename k8s
<!-- offline end -->
<!-- juju control start -->
juju deploy k8s --channel=1.35/stable --base="ubuntu@24.04"
<!-- juju control end -->
<!-- juju worker start -->
juju deploy k8s-worker --channel=1.35/stable -n 2 --base="ubuntu@24.04"
<!-- juju worker end -->
