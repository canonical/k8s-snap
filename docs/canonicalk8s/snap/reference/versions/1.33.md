...
- Version bumps
    ...
    - Microcluster v2.2.1
    - k8s-snap-api v1.1.0 
- Update containerd to v1.7.30 to address CVE-2024-25621
- Update Cilium to v1.17.12 with static images
...
([#2338](https://github.com/canonical/k8s-snap/pull/2338))
...
([#2122](https://github.com/canonical/k8s-snap/pull/2122), 
[#1860](https://github.com/canonical/k8s-snap/pull/1860), 
[#2365](https://github.com/canonical/k8s-snap/pull/2365), 
[#2402](https://github.com/canonical/k8s-snap/pull/2402))
- Harden TLS cipher suites for kube-apiserver as per Mozilla intermediate 
profile
