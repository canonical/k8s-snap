...
- Fix handling of expired resource versions in ConfigMap watches to ensure 
seamless recovery.
...
- Query the k8s API server through the current endpoints, rather than 
localhost ([#1949](https://github.com/canonical/k8s-snap/pull/1949))
