...
The Canonical Kubernetes codebase references the `k8sd` and `k8s-snap-api` package
...
1. Clone the `k8sd` and `k8s-snap-api` repositories from
   https://github.com/canonical/k8sd and https://github.com/canonical/k8s-snap-api
