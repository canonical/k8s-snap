...
resource utilization. See our [DNS guide](/snap/explanation/networking.md#dns) for more information.
...
- Pin Kubernetes and Helm versions to prevent unintended cross-minor upgrades.
- Trigger feature controllers on annotation changes to ensure proper reconciliation.
