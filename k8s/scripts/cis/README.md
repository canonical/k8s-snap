...
For example, the current set of markdown files in docs/_parts/cis were generated using the following folder as the input directory: [ck8s-cis-1.24](https://github.com/canonical/kube-bench/tree/ck8s-etcd/cfg/ck8s-cis-1.24)
...
cd kube-bench && git checkout ck8s-etcd
cd ..
```
